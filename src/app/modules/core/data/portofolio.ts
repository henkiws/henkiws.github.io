...
export const Portofolios: Portofolio[] = [{
  ...
  },
  {
    ...
    resources: '<li>Access the project source on <span class="fancy"><a target="_blank" href="https://sepedanesia.com">SEPEDANESIA</a></span></li>'
  },
  {
    slug: "web-blog",
    title: "Web Blog",
    ...
    images: [{
        url: 'https://raw.githubusercontent.com/henkiws/Web-Blog/master/screenshoot/home.png',
        text: 'Web Blog',
        desc: ''
      }
    ],
    about: "<p>Project developed to improve skills and learn new things. I use Laravel Framework.</p>",
    technical: "<li>Laravel</li><li>MySql</li><li>U-Bold Template</li>",
    resources: '<li>Access the project source on <span class="fancy"><a target="_blank" href="https://github.com/henkiws">GITHUB</a></span></li>'
  },
  // {
  //   slug: "tour-fyine",
